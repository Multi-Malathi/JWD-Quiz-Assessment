...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const quizArray = [
    ...
    {
      q: 'when is boxing day in Australia?',
      o: ['24 December', '24 January', '26 January', '26 December'],
      a: 3, // array index 3 - so 26 December is the correct answer here
    },
    {
    ...
    {
      q: 'in which season australia celebrate christmas?',
      o: ['Winter', 'Summer', 'Spring', 'Autumn'],
      a: 1, // array index 1 - so Summer is the correct answer here
    },
  ];
